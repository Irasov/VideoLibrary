...
<form action="${pageContext.request.contextPath}/start" method="get">
    <div>
        <p><input type="radio" name="request" value="find by id" checked title="Find by id"/>Find by id. Enter id <textarea name="id" id="id" cols="2" rows="1" title="Enter id">1</textarea></p>
